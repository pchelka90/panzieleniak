<?php
    ...
    $message_body="Formularz kontaktowy wysłany ze strony www.panzieleniak.pl\n";
    $message_body="Imię i nazwisko: $name\n";
    $message_body="Adres email: $email\n";
    $message_body="Numer telefonu: $phone\n\n";
    $message_body=$message;
    if(mail("bartlomiejbronkowski90@gmail.com","Formularz kontaktowy",$message_body,$headers)){
