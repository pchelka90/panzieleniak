<?php
  ...
  function tworz_stopke_html() {
    echo '<div class="lefty">
          ...
          <br />
          kreacja: <a href=:https://pchelka90.github.io/portfolio-website/" target="_blank">Bartłomiej Bronkowski</a>
          </div>
...
function tworz_html_url($url, $nazwa) {
  ...
  echo '<a href="<?php echo $url; ?>"><?php echo $nazwa; ?></a><br />';
}
                    ...
                    if (@file_exists("images/".$rzad['isbn'].".jpg")) {
                      $tytul = "<div style='width:167px;float:left;margin:7px;text-align:center;
                                  ...
                                  <div style='height:150px'>
                                    <img src=\"images/".($rzad['isbn']).".jpg\"></img>
                                    <br />
                                  </div>
                                </div>";
                                tworz_html_url($url, $tytul);
                              ...
                              echo "<div id='slider-left' class='slider-nav'>
  ...
  if (is_array($produkt)) {
    ...
    if (@file_exists('images/'.($produkt['isbn']).".jpg")) {
      ...
      if(($wielkosc[0] > 0) && ($wielkosc[1] > 0)) {
        echo '<img src=\"images/"' .$produkt["isbn"].'".jpg\" style=\"border:1px solid black\"/>
          </div>';
        }
      }
	    echo "&nbsp;";
...
function wyswietl_form_kasy() {
  ...
  echo '<br />
          ...
          <tr>
            ...
            <td>
              <input class="formularz" type="tel" name="telefon" pattern="[0-9]{3}[0-9]{3}[0-9]{3}" value = "<?php echo "'.$_SESSION["telefon"].'" ?>" maxlength="11" size="40"/>
            </td>
          </tr>
          <tr>
            <td>Imię</td>
            <td>
              <input class="formularz" type = "text" name = "imie" value = "<?php echo "'.$_SESSION["imie"].'"  ?>" maxlength="40" size="40"/>
            </td>
          </tr>
          <tr>
            <td>Nazwa ulicy</td>
            <td>
              <input class="formularz" type="text" name="ulica" list="ulica" value="<?php echo "'.$_SESSION["ulica"].'" ?>" maxlength="40" size="40"/>
            </td>
          </tr>
          <tr>
            <td>Numer budynku</td>
            <td>
            <input class="formularz" type="number" name="budynek" min="1" value="<?php echo"'.$_SESSION["budynek"].'" ?>" maxlength="3" size="40"/>
            </td>
          </tr>
          <tr>
            <td>Numer mieszkania</td>
            <td>
              <input class="formularz" type="number" name="mieszkanie" min="1" max="100" value="<?php echo"'.$_SESSION["mieszkanie"].'" ?>" maxlength="2" size="40"/>
            </td>
          </tr>
          <tr>
            <td>Adres e-mail</td>
            <td>
              <input class="formularz" type = "text" name = "email" value = "<?php echo"'.$_SESSION["email"].'" ?>" maxlength="40" size="40"/>
            </td>
          </tr>
          <tr>
            <th colspan="2" bgcolor="#cccccc">Adres dostawy (proszę zostawić puste jeżeli taki sam jak powyższy)</th>
          </tr>
          <tr>
            <td>Numer telefonu</td>
  ...
  if($zmiana == true) {
    echo '<tr>
            ...
            <td align=\"center\">
              ...
              <input type=\"image\" src=\"images/zapisz-zmiany.png\" border=\"0\" alt=\"Zapisz zmiany\">
            </td>
            <td>&nbsp;</td>
          </tr>';
        }
...
function wyswietl_przycisk($cel, $obrazek, $alt) {
  echo '<div align=\"center\">
          <a href=\"$cel\">
            <img src=\"images/'.$obrazek.'".png\" alt=\"'.$alt.'"\ border=\"0\" height=\"50\" width=\"150\">
          </a>
        </div>';
}
...
function wyswietl_form_przycisk($obrazek, $alt) {
  echo '<div align=\"center\">
          <input type=\"image\" src=\"images/"'.$obrazek.'".png\" alt=\"'.$alt.'\" border=\"0\" height=\"50\" width=\"135\" />
        </div>';
      }
...
function wyswietl_menu_administratora() {
